...
> Note: Some older or more complicated shiny apps may separate the app scripts into `ui.R` and `server.R` but for this workshop, we will use the single script approach (`app.R`)
